...
# a user will be prompted for their weight in pounds and the program will output weight in kgs
...
def get_positive_float_input():
    while True:
        try:
            ...
            # validate the user_weight is positive, if not positive, reprompt the user
            if user_weight <= 0:
